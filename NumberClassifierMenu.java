...
public class NumberClassifierMenu {
    public static void main(String[] args) {
        ...
        // Start the loop that shows the menu until the user decides to exit
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    userChoice = 'N'; // Exit condition for the loop
                    break;
            ...
            // Ask if the user wants to continue after performing the operation
            if (userChoice != 'N') {
        ...
        } while (userChoice == 'Y'); // Loop continues if userChoice is 'Y'
